...
<body class="theme-light">
    ...
    <div id="page" class="pattern-grid-xl color-highlight">
        ...
        <div class="header header-fixed header-logo-center">
            <a href="/" class="header-title">Bodywaxing</a>
        ...
        <div class="page-content header-clear-medium">
                ...
                <!--#red Hero-->
        <div class="card card-style mb-4 bg-highlight bg-1" data-card-height="300" style="height: 300px;"> 
      ...
      <!--cta | end-->
        ...
        <!--wax menu | start-->
        <div id="face" class="content row mb-4"></div>
        <!--wax menu | end-->
